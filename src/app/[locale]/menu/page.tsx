...
import { MOCK_DISHES, DISH_CATEGORIES, getCategoryTheme } from '@/features/dish/data/dishes';
...
export default function MenuPage() {
  ...
  const filteredDishes = useMemo(() => {
    if (activeCategory === 'all') return MOCK_DISHES;
    return MOCK_DISHES.filter((dish) => dish.category === activeCategory);
  }, [activeCategory]);
